...
const Services = () => {
    return (
        <section id="services" className="services-section">
            ...
            <h3>2. Scheduling Interface</h3>
            <p><strong>Weekly Pick-Ups:</strong> Bins are collected every Saturday, with reminders sent via email or SMS.</p>
            <p><strong>Emergency Pick-Ups:</strong> Request on-demand service through our website or app for full bins before the scheduled day.</p>
